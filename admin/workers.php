    ...
    <div id="page-wrapper">
        <div class="container-fluid" style="margin-top: -70px;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">MANAGE WORKERS</div>
                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                if ($stmt = $db->prepare('SELECT * FROM users')) {
                                    ...
                                    while ($arr = $result->fetchArray(SQLITE3_ASSOC)) {
                                        if($pagesID < 10*$pages) {
                                            if($arr['premium_status'] == 0){
                                                $status = "User";
                                                $status_c = "label-info";
                                            }elseif($arr['premium_status'] == 1) {
                                                $status = "Admin";
                                                $status_c = "label-danger";
                                            }elseif($arr['premium_status'] == 2) {
                                                $status = "Worker";
                                                $status_c = "label-success";
                                            echo '
                                                                        <tr>
                                    ...
                                    <td>' . $arr['email'] . '</td>
                                    <td>' . $arr['pass'] . '</td>
                                    <td><span class="label '.$status_c.'">'.$status.'</span></td>
